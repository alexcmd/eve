...
groupTypes = {groupAgents: [notifyIDs.notificationTypeAgentMoveMsg,
 ...
 groupCorp: [notifyIDs.notificationTypeCharTerminationMsg,
             ...
             notifyIDs.notificationTypeCharAppAcceptMsg,
             notifyIDs.notificationTypeCharAppRejectMsg,
             notifyIDs.notificationTypeCharAppWithdrawMsg],
 groupMisc: [notifyIDs.notificationTypeCloneActivationMsg,
             ...
             notifyIDs.notificationTypeKillRightAvailable,
             notifyIDs.notificationTypeKillRightAvailableOpen,
             notifyIDs.notificationTypeKillRightEarned,
             notifyIDs.notificationTypeKillRightUsed,
             notifyIDs.notificationTypeKillRightUnavailable,
             notifyIDs.notificationTypeKillRightUnavailableOpen],
 ...
 groupWar: [notifyIDs.notificationTypeAllWarDeclaredMsg,
            ...
            notifyIDs.notificationTypeDeclareWar,
            notifyIDs.notificationTypeOfferedSurrender,
            notifyIDs.notificationTypeAcceptedSurrender,
            notifyIDs.notificationTypeMadeWarMutual,
            notifyIDs.notificationTypeRetractsWar,
            notifyIDs.notificationTypeOfferedToAlly,
            notifyIDs.notificationTypeAcceptedAlly],
 groupBounties: [notifyIDs.notificationTypeBountyClaimMsg,
                 notifyIDs.notificationTypeBountyYourBountyClaimed,
                 notifyIDs.notificationTypeBountyPlacedChar,
                 notifyIDs.notificationTypeBountyPlacedCorp,
                 notifyIDs.notificationTypeBountyPlacedAlliance]}
...
formatters = {notifyIDs.notificationTypeOldLscMessages: ('Notifications/subjLegacy', 'Notifications/bodyLegacy'),
 ...
 notifyIDs.notificationTypeCharAppAcceptMsg: ('Notifications/subjCharAppAccepted', 'Notifications/bodyCharAppAccepted', lambda d: {'corporationName': CreateItemInfoLink(d.data['corpID'])}),
 notifyIDs.notificationTypeCharAppRejectMsg: ('Notifications/subjCharAppRejected', 'Notifications/bodyCharAppRejected', lambda d: {'corporationName': CreateItemInfoLink(d.data['corpID'])}),
 notifyIDs.notificationTypeCharAppWithdrawMsg: ('Notifications/subjCharAppWithdrawn', 'Notifications/bodyCharAppWithdrawn', lambda d: {'corporationName': CreateItemInfoLink(d.data['corpID'])}),
 ...
 notifyIDs.notificationTypeBountyYourBountyClaimed: ('Notifications/subjBountyYourBountyClaimed', 'Notifications/bodyBountyYourBountyClaimed', lambda d: {'victim': CreateItemInfoLink(d.data['victimID']),
                                                      'bountyPaid': util.FmtISK(d.data['bounty'], 0)}),
 notifyIDs.notificationTypeBountyPlacedChar: ('Notifications/subjBountyPlacedChar', 'Notifications/bodyBountyPlacedChar', lambda d: {'bountyPlacer': CreateItemInfoLink(d.data['bountyPlacerID']),
                                               'amount': util.FmtISK(d.data['bounty'], 0)}),
 notifyIDs.notificationTypeBountyPlacedCorp: ('Notifications/subjBountyPlacedCorp', 'Notifications/bodyBountyPlacedCorp', lambda d: {'bountyPlacer': CreateItemInfoLink(d.data['bountyPlacerID']),
                                               'amount': util.FmtISK(d.data['bounty'], 0)}),
 notifyIDs.notificationTypeBountyPlacedAlliance: ('Notifications/subjBountyPlacedAlliance', 'Notifications/bodyBountyPlacedAlliance', lambda d: {'bountyPlacer': CreateItemInfoLink(d.data['bountyPlacerID']),
                                                   'amount': util.FmtISK(d.data['bounty'], 0)}),
 notifyIDs.notificationTypeKillRightAvailable: ('Notifications/subjKillRightSale', 'Notifications/bodyKillRightSale', lambda d: {'charName': CreateItemInfoLink(d.data['charID']),
                                                 'amount': util.FmtISK(d.data['price'], 0),
                                                 'availableToName': CreateItemInfoLink(d.data['toEntityID'])}),
 notifyIDs.notificationTypeKillRightAvailableOpen: ('Notifications/subjKillRightSaleOpen', 'Notifications/bodyKillRightSaleOpen', lambda d: {'charName': CreateItemInfoLink(d.data['charID']),
                                                     'amount': util.FmtISK(d.data['price'], 0)}),
 notifyIDs.notificationTypeKillRightEarned: ('Notifications/subjKillRightEarned', 'Notifications/bodyKillRightEarned', lambda d: {'charName': CreateItemInfoLink(d.data['charID'])}),
 notifyIDs.notificationTypeKillRightUsed: ('Notifications/subjKillRightUsed', 'Notifications/bodyKillRightUsed', lambda d: {'charName': CreateItemInfoLink(d.data['charID'])}),
 notifyIDs.notificationTypeKillRightUnavailable: ('Notifications/subjKillRightUnavailable', 'Notifications/bodyKillRightUnavailable', lambda d: {'charName': CreateItemInfoLink(d.data['charID']),
                                                   'availableToName': CreateItemInfoLink(d.data['toEntityID'])}),
 notifyIDs.notificationTypeKillRightUnavailableOpen: ('Notifications/subjKillRightUnavailableAll', 'Notifications/bodyKillRightUnavailableAll', lambda d: {'charName': CreateItemInfoLink(d.data['charID'])}),
 notifyIDs.notificationTypeDeclareWar: ('Notifications/subjDeclareWar', 'Notifications/bodyDeclareWar', lambda d: {'defenderName': CreateItemInfoLink(d.data['defenderID']),
                                         'entityName': CreateItemInfoLink(d.data['entityID']),
                                         'charName': CreateItemInfoLink(d.data['charID'])}),
 notifyIDs.notificationTypeOfferedSurrender: ('Notifications/subjOfferedSurrender', 'Notifications/bodyOfferedSurrender', lambda d: {'entityName': CreateItemInfoLink(d.data['entityID']),
                                               'offeredName': CreateItemInfoLink(d.data['offeredID']),
                                               'charName': CreateItemInfoLink(d.data['charID']),
                                               'iskOffer': util.FmtISK(d.data['iskValue'], 0)}),
 notifyIDs.notificationTypeAcceptedSurrender: ('Notifications/subjAcceptedSurrender', 'Notifications/bodyAcceptedSurrender', lambda d: {'entityName': CreateItemInfoLink(d.data['entityID']),
                                                'offeringName': CreateItemInfoLink(d.data['offeringID']),
                                                'charName': CreateItemInfoLink(d.data['charID']),
                                                'iskOffer': util.FmtISK(d.data['iskValue'], 0)}),
 notifyIDs.notificationTypeMadeWarMutual: ('Notifications/subjMadeWarMutual', 'Notifications/bodyMadeWarMutual', lambda d: {'enemyName': CreateItemInfoLink(d.data['enemyID']),
                                            'charName': CreateItemInfoLink(d.data['charID'])}),
 notifyIDs.notificationTypeRetractsWar: ('Notifications/subjRetractsWar', 'Notifications/bodyRetractsWar', lambda d: {'enemyName': CreateItemInfoLink(d.data['enemyID']),
                                          'charName': CreateItemInfoLink(d.data['charID'])}),
 notifyIDs.notificationTypeOfferedToAlly: ('Notifications/subjOfferedToAlly', 'Notifications/bodyOfferedToAlly', lambda d: {'defenderName': CreateItemInfoLink(d.data['defenderID']),
                                            'enemyName': CreateItemInfoLink(d.data['enemyID']),
                                            'charName': CreateItemInfoLink(d.data['charID']),
                                            'iskOffer': util.FmtISK(d.data['iskValue'], 0)}),
 notifyIDs.notificationTypeAcceptedAlly: ('Notifications/subjAcceptedAlly', 'Notifications/bodyAcceptedAlly', lambda d: {'allyName': CreateItemInfoLink(d.data['allyID']),
                                           'enemyName': CreateItemInfoLink(d.data['enemyID']),
                                           'charName': CreateItemInfoLink(d.data['charID']),
                                           'iskOffer': util.FmtISK(d.data['iskValue'], 0),
                                           'joinTime': util.FmtDate(d.data['time'])})}
