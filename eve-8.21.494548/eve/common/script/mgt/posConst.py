#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/common/script/mgt/posConst.py
import blue
...
exports = {'pos.IsStructureAnchored': IsStructureAnchored,
 ...
 'pos.DISPLAY_NAMES': {STRUCTURE_ANCHORED: 'Entities/States/Anchored',
                       STRUCTURE_UNANCHORED: 'Entities/States/Unanchored',
                       STRUCTURE_ONLINING: 'Entities/States/Onlining',
                       STRUCTURE_REINFORCED: 'Entities/States/Reinforced',
                       STRUCTURE_ONLINE: 'Entities/States/Online',
                       STRUCTURE_OPERATING: 'Entities/States/Operating',
                       STRUCTURE_VULNERABLE: 'Entities/States/Vulnerable',
                       STRUCTURE_SHIELD_REINFORCE: 'Entities/States/ShieldReinforcedVerbose',
                       STRUCTURE_ARMOR_REINFORCE: 'Entities/States/ArmorReinforcedVerbose',
                       STRUCTURE_INVULNERABLE: 'Entities/States/Invulnerable'}}