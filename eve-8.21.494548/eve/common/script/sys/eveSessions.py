#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/common/script/sys/eveSessions.py
import blue
import uthread
import weakref
import log
...
class Session(base.CoreSession):
    ...
    def __init__(self, sid, localSID, role, sessionType):
        base.CoreSession.__init__(self, sid, localSID, role, sessionType, ['locationid', 'corprole'])
