#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/common/script/paperDoll/paperDollDataManagement.py
import os
import uthread
import copy
import yaml
...
class BuildData(BuildDataMaps):
    ...
    def IsMeshDirty(self):
        return self.__cmpMeshes != self.meshes or self.clothPath and not self.clothData or any(map(lambda mesh: not (mesh.geometry and mesh.geometry.isGood), self.meshes))
...
class BuildDataManager(object):
    ...
    def __init__(self):
        ...
        self.__modifiers = {PD.DOLL_PARTS.BODY: [],
         PD.DOLL_PARTS.HEAD: [],
         PD.DOLL_PARTS.HAIR: [],
...
exports = {'paperDoll.LoadYamlFileNicely': LoadYamlFileNicely,
 'paperDoll.SaveMapsToDisk': SaveMapsToDisk,
