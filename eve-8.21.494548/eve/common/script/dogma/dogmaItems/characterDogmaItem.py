...
class CharacterDogmaItem(dogmax.ShipFittableDogmaItem):
    ...
    def Load(self, item, instanceRow):
        ...
        if util.IsDustCharacter(item.itemID):
            attrs[const.attributeIntelligence] = 20
            attrs[const.attributeCharisma] = 20
            attrs[const.attributePerception] = 20
            attrs[const.attributeMemory] = 20
            attrs[const.attributeWillpower] = 20
            return
