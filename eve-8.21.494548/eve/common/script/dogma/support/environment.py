#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/common/script/dogma/support/environment.py
import blue
import random
...
class Environment:
    ...
    def __init__(self, itemID, charID, shipID, targetID, otherID, effectID, dogmaLM, expressionID):
        ...
        if self.otherTypeID in const.orbitalStrikeAmmo:
            self.actualEffectID = const.effectOrbitalStrike
