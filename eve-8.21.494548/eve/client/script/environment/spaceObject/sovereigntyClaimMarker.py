...
class SovereigntyClaimMarker(spaceObject.LargeCollidableStructure):
    ...
    def LoadModel(self):
        ...
        if self.posState == pos.STRUCTURE_INVULNERABLE:
            self.posState = pos.STRUCTURE_ONLINE
    ...
    def HandleStateChange(self, posState, posTime, posDelay):
        if self.posState == posState:
            return
        if self.posState == pos.STRUCTURE_ONLINING and posState == pos.STRUCTURE_INVULNERABLE:
            posState = pos.STRUCTURE_ONLINE
