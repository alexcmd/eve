...
definitions = {'effects.AnchorDrop': (effects.AnchorDrop,
 ...
 'effects.Mining': (effects.StandardWeapon,
                    ...
                    1,
                    10000),
 'effects.MissileDeployment': (effects.MissileLaunch,
                               FX_TF_NONE,
                               FX_MERGE_SHIP | FX_MERGE_MODULE | FX_MERGE_GUID,
                               None,
                               1,
 ...
 'effects.WormholeActivity': (effects.WormholeActivity,
                              ...
                              1,
                              10000),
 'effects.TargetBreaker': (effects.ShipEffect,
                           FX_TF_SCALE_RADIUS | FX_TF_POSITION_BALL,
                           FX_MERGE_SHIP | FX_MERGE_GUID,
                           'res:/dx9/model/Effect/TargetBreakerPulse.red',
                           0,
                           10000),
 'effects.OrbitalStrike': (effects.OrbitalStrike,
                           FX_TF_NONE,
                           FX_MERGE_SHIP | FX_MERGE_MODULE | FX_MERGE_GUID,
                           None,
                           1,
                           10000),
 'effects.MicroJumpDriveEngage': (effects.MicroJumpDriveEngage,
                                  FX_TF_SCALE_RADIUS | FX_TF_POSITION_BALL | FX_TF_ROTATION_BALL,
                                  FX_MERGE_SHIP | FX_MERGE_GUID,
                                  'res:/dx9/model/effect/mjd_effect.red',
                                  1,
                                  10000),
 'effects.MicroJumpDriveJump': (effects.MicroJumpDriveJump,
                                FX_TF_NONE,
                                FX_MERGE_SHIP | FX_MERGE_GUID,
                                None,
                                1,
