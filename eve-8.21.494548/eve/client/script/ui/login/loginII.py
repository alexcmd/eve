#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/login/loginII.py
import blue
import uthread
import uix
import uiutil
...
if boot.region == 'optic':
    LIVE_SERVER1 = '211.144.214.68'
    LIVE_SERVER2 = '218.83.152.23'
    ...
    def OnEsc(self):
        if not self.waitingForEula and self.pushButtons is not None:
            ...
            if activePanelArgs:
                ...
                print activePanelName
                self.pushButtons.DeselectAll()
            else:
                self.pushButtons.SelectPanelByArgs(('settings',))
