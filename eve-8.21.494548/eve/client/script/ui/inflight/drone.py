#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/inflight/drone.py
import uix
import uiutil
import blue
import uthread
...
class DroneEntry(listentry.BaseTacticalEntry):
    ...
    def UpdateState(self, droneState = None):
        ...
        droneStates = {entities.STATE_IDLE: 'UI/Inflight/Drone/Idle',
         ...
         entities.STATE_FLEEING: 'UI/Inflight/Drone/Repairing',
...
class DroneView(form.ActionPanel):
    ...
    def default_left(*args):
        return uicore.desktop.width - form.DroneView.default_width - 16
