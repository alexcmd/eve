#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/services/character.py
import service
import paperDoll
...
class Character(service.Service):
    ...
    def factory(self):
        ...
        factory.clothSimulationActive = settings.public.device.Get('charClothSimulation', defaultClothSim)
        return factory
