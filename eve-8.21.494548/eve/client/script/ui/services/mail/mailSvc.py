#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/services/mail/mailSvc.py
import service
import blue
import sys
import log
...
class mailSvc(service.Service):
    ...
    def MailMenu(self, *args):
        m = [(uiutil.MenuLabel('UI/Mail/DisableNotification'), self.DisableNotification)]
        return m
