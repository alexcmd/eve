#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/services/standingsvc.py
import service
import blue
import uthread
import uix
...
class StandingTransactionsWnd(uicls.Window):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.sr.scroll = uicls.Scroll(name='standingsTransactions', parent=self.sr.main, padding=(const.defaultPadding,
        ...
        uicls.EveLabelSmall(text=localization.GetByLabel('UI/Common/Date'), parent=inpt, width=200, top=-12)
...
class StandingEntry(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *etc):
        self.sr.label = uicls.EveLabelMedium(text='', parent=self, left=36, top=0, state=uiconst.UI_DISABLED, color=None, maxLines=1, align=uiconst.CENTERLEFT)
...
class FactionStandingEntry(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *etc):
        self.sr.label = uicls.EveLabelMedium(text='', parent=self, left=36, top=0, state=uiconst.UI_DISABLED, maxLines=1, align=uiconst.TOPLEFT)
        self.sr.otherlabel = uicls.EveLabelMedium(text='', parent=self, left=36, top=0, state=uiconst.UI_DISABLED, maxLines=1, align=uiconst.BOTTOMLEFT)
        uicls.Line(parent=self, align=uiconst.TOBOTTOM)
