#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/ctrltab.py
import uix
import xtriui
import uiconst
import math
...
class CtrlTabWindow(uicls.Window):
    ...
    def InitializeWindowIcons(self):
        currOpenWindows = [ wnd for wnd in uicore.registry.GetWindows() if not isinstance(wnd, uicls.WindowStack) ]
        self.windowIcons = []
        i = 0
