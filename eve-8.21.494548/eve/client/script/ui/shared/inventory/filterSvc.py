...
class CriteriaValueInt(CriteriaValueBase):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.criteriaCombo = self.CreateCombo(options)
        self.criteriaCombo.SelectItemByValue(self.criteria)
        self.valueEdit = uicls.SinglelineEdit(name='valueEdit', parent=self, align=uiconst.TOLEFT_PROP, ints=self.ints, floats=self.floats, setvalue=self.value, padLeft=4, width=0.5, OnFocusLost=self.ApplyFilter, OnReturn=self.ApplyFilter, OnChange=self.ApplyFilter)
...
class CriteriaValueString(CriteriaValueBase):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.criteriaCombo = self.CreateCombo(options)
        self.criteriaCombo.SelectItemByValue(self.criteria)
        self.valueEdit = uicls.SinglelineEdit(name='valueEdit', parent=self, align=uiconst.TOLEFT_PROP, setvalue=self.value, padLeft=4, width=0.5, OnFocusLost=self.ApplyFilter, OnReturn=self.ApplyFilter, OnChange=self.ApplyFilter)
