...
class PreviewWnd(uicls.Window):
    ...
    __notifyevents__ = ['OnSetDevice', 'OnResizeUpdate', 'OnNCCgreenscreenChanged']
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.sr.title = uicls.EveCaptionMedium(text='', parent=rightSide, align=uiconst.TOTOP, padding=(17, 4, 17, 0), state=uiconst.UI_NORMAL)
    ...
    def PreviewCharacter_thread(self, charID, dna):
        try:
            ...
            if settings.user.ui.Get('NCCgreenscreen', 0):
                backgroundImage = 'res:/UI/Texture/CharacterCreation/backdrops/Background_1001.dds'
            else:
                backgroundImage = None
            self.sr.sceneContainer.PrepareInteriorScene(addShadowStep=True, backgroundImage=backgroundImage)
            ...
            if not settings.user.ui.Get('NCCgreenscreen', 0):
            ...
            self.sr.sceneContainer.cameraParent.value = trinity.TriVector(*center)
    ...
    def PreviewType(self, typeID, subsystems = None):
        ...
        if categoryID == const.categoryShip and techLevel == 3.0:
            ...
            self.sr.sceneContainer.cameraParent.value = trinity.TriVector(9.0, -1000, 0.0)
