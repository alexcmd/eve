#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/medalribbonranks.py
import uix
import uiutil
import xtriui
import listentry
...
class ImageSlider(uicls.Container):
    ...
    def GetActiveFrame(self):
        if self.sr.activeframe is None:
            self.sr.activeframe = uicls.Frame(parent=self.sr.mainpar, left=0, top=0, width=0, height=0, color=(1.0,
             1.0,
             1.0,
