#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/fleet/fleetwindow.py
import uix
import uiconst
import uiutil
import xtriui
...
class FleetWindow(uicls.Window):
    ...
    def InitBroadcastBottom(self):
        ...
        self.sr.lastVoiceEventCont = uicls.Container(name='lastVoiceEventCont', parent=self.sr.broadcastBottom, align=uiconst.TOTOP_PROP, top=0, left=0, height=1.0, width=1.0, state=uiconst.UI_PICKCHILDREN)
    ...
    def GetFleetMenuTop(self):
        ...
        if session.fleetid is None:
            ...
            ret.append((uiutil.MenuLabel('UI/Fleet/FleetBroadcast/BroadcastSettings'), lambda : form.BroadcastSettings.Open()))
            if self.isFlat:
    ...
    def OnFleetBroadcast_Local(self, broadcast):
        ...
        t = uicls.EveLabelMedium(text=caption, parent=self.sr.lastBroadcastCont, align=uiconst.TOALL, left=25, maxLines=1, state=uiconst.UI_DISABLED)
    ...
    def OnSpeakingEvent_Local(self, data):
        ...
        t = uicls.EveLabelMedium(text=caption, parent=self.sr.lastVoiceEventCont, align=uiconst.TOALL, left=25, maxLines=1)
        lt = t
