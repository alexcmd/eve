...
class CalendarNewEventWnd(uicls.Window):
    ...
    def OpenAddInvteeWnd(self, *args):
        ...
        form.CharacterSearchWindow.CloseIfOpen(windowID='searchWindow_calendar')
        extraIconHintFlag = ['ui_73_16_13', localization.GetByLabel('UI/Calendar/Hints/CharacterAdded'), False]
        wnd = form.CharacterSearchWindow.Open(windowID='searchWindow_calendar', actionBtns=actionBtn, caption=caption, input='', getMyCorp=False, getMyLists=False, getMyAlliance=False, showContactList=True, extraIconHintFlag=extraIconHintFlag, configname=self.configname)
    ...
    def _OnClose(self, *args):
        wnd = form.CharacterSearchWindow.GetIfOpen(windowID='searchWindow_calendar')
...
class CalendarListEntry(listentry.Generic):
    ...
    def GetHeight(self, node, width):
        ...
        return listentry.CalendarListEntry.TEXTMARGIN * 2 + labelHeight + timeHeight
