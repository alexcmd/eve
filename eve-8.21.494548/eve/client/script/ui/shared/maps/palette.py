#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/maps/palette.py
import blue
import uthread
import uiutil
import trinity
...
class MapPalette(uicls.Window):
    ...
    def GetSovereignty_FactionalWarfareOptions(self):
        warfactionlist = []
