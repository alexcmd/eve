#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/evemailingListConfig.py
import uix
import xtriui
import form
import util
...
class MaillistSetupWindow(uicls.Window):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.sr.tabs = uicls.TabGroup(name='tabs', parent=self.sr.main)
