...
class CorpWars(uicls.Container):
    ...
    def Load(self, args):
        if not self.sr.Get('inited', 0):
            ...
            self.allWarsCont = uicls.Container(name='allWarsCont', parent=self, align=uiconst.TOALL)
            allWarsSettingsCont = uicls.Container(name='allWarsSettingsCont', parent=self.allWarsCont, align=uiconst.TOTOP, height=18, top=2)
            browseCont = uicls.Container(name='browseCont', parent=self.allWarsCont, align=uiconst.TOBOTTOM, height=22, padding=(const.defaultPadding,
             0,
            ...
            self.killReportsCont = uicls.Container(name='killReportsCont', parent=self, align=uiconst.TOALL)
