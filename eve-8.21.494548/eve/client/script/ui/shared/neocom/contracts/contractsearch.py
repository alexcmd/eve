...
class ContractSearchWindow(uicls.Container):
    ...
    def InitFilters(self):
        ...
        if contractType != const.conTypeCourier:
            ...
            self.sr.typeName = c = uicls.SinglelineEdit(name='type', parent=typeCont, label='', hinttext=localization.GetByLabel('UI/Wallet/WalletWindow/ItemType'), setvalue=settings.user.ui.Get('contracts_search_typename', ''), align=uiconst.TOTOP, padTop=20, OnReturn=self.DoSearch)
        ...
        if contractType == const.conTypeCourier:
            ...
            self.sr.fltDropOff = c = uicls.SinglelineEdit(name='dropoff', parent=dropoffCont, setvalue=settings.user.ui.Get('contracts_search_dropoff', ''), align=uiconst.TOTOP, label='', padRight=w, hinttext=localization.GetByLabel('UI/Contracts/ContractsSearch/DropOffLocation'), OnReturn=self.OnDropOffReturn)
