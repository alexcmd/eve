#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/Alliances/all_ui_applications.py
import blue
import uthread
import util
import xtriui
...
import service
import uiutil
STATUSDICT = {const.allianceApplicationNew: 'UI/Corporations/CorporationWindow/Alliances/Applications/New',
 const.allianceApplicationAccepted: 'UI/Corporations/CorporationWindow/Alliances/Applications/Accepted',
 const.allianceApplicationEffective: 'UI/Corporations/CorporationWindow/Alliances/Applications/Effective',
 const.allianceApplicationRejected: 'UI/Corporations/CorporationWindow/Alliances/Applications/Rejected'}
...
class ApplyToAllianceWnd(uicls.Window):
    ...
    def ConstructLayout(self):
        ...
        allianceInfoCont = uicls.Container(name='allianceInfo', parent=self.sr.main, align=uiconst.TOTOP, height=68, padding=const.defaultPadding)
        allianceLogoCont = uicls.Container(name='allianceLogo', parent=allianceInfoCont, align=uiconst.TOLEFT, width=68)
        allianceTextCont = uicls.Container(name='allianceName', parent=allianceInfoCont, align=uiconst.TOALL)
        applicationCont = uicls.Container(name='allianceInfo', parent=self.sr.main, align=uiconst.TOALL, padding=(const.defaultPadding,
         0,
         const.defaultPadding,
         const.defaultPadding))
        ...
        allianceNameLabel = uicls.EveLabelLarge(parent=allianceTextCont, text=allianceText, top=12, align=uiconst.TOPLEFT, width=270)
        ...
        editLabel = uicls.EveLabelSmall(parent=applicationCont, text=editText, height=16, align=uiconst.TOTOP)
        ...
        appLabel = uicls.EveLabelMedium(parent=applicationCont, text=appText, align=uiconst.TOTOP, top=8)
...
class MyAllianceApplicationWnd(uicls.Window):
    ...
    def ConstructLayout(self):
        ...
        status = uicls.EveLabelSmall(parent=applicationCont, text=localization.GetByLabel('UI/Corporations/CorporationWindow/Alliances/Applications/Status'), align=uiconst.TOTOP, top=6)
        statusText = STATUSDICT[self.application.state]
        statusLabel = uicls.EveLabelSmallBold(parent=applicationCont, text=localization.GetByLabel(statusText), height=12, align=uiconst.TOTOP)
