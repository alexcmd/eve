#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/petition.py
import sys
import blue
import uthread
import uix
...
class PetitionSvc(service.Service):
    ...
    def ShowRating(self, *args):
        ...
        mainCaption = uicls.EveCaptionMedium(text=localization.GetByLabel('UI/Neocom/Petition/RateHeader'), parent=captionPar, align=uiconst.RELATIVE, left=const.defaultPadding, top=8)
...
class LogField(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *args):
        ...
        self.selection = None
        self.sr.subject = uicls.EveLabelSmall(text='', parent=self, left=26, top=2, state=uiconst.UI_DISABLED, tabs=[200, 500])
...
class MessageField(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *args):
        ...
        self.sr.selection = uicls.Fill(parent=self, padding=(0, 1, 0, 1), name='selection', state=uiconst.UI_DISABLED, color=(1.0, 1.0, 1.0, 0.25))
        self.selection = None
        self.sr.subject = uicls.EveLabelSmall(text='', parent=self, left=26, top=2, state=uiconst.UI_DISABLED, tabs=[120, 500])
        self.state = uiconst.UI_NORMAL
