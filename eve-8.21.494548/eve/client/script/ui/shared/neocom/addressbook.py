#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/addressbook.py
import sys
import service
import blue
import uthread
...
class ContactsForm(uicls.Container):
    ...
    def DrawStuff(self, *args):
        ...
        systemStatsCont = uicls.DragResizeCont(name='systemStatsCont', settingsID='contactsListSplit', parent=self.sr.mainCont, align=uiconst.TOLEFT, minSize=100, maxSize=200, defaultSize=160)
        self.sr.leftCont = uicls.Container(name='leftCont', parent=systemStatsCont.mainCont, padding=(const.defaultPadding,
         0,
         0,
         0))
        ...
        self.sr.rightCont = uicls.Container(name='rightCont', parent=self.sr.mainCont, padding=(0,
         0,
         const.defaultPadding,
         const.defaultPadding))
...
class ContactManagementWnd(uicls.Window):
    ...
    def ConstructLayout(self):
        ...
        topRightCont = uicls.Container(name='topRightCont', parent=topCont, align=uiconst.TOALL, pos=(0, 0, 0, 0), padding=(const.defaultPadding,
         ...
         0,
         0))
        nameCont = uicls.Container(name='nameCont', parent=topRightCont, align=uiconst.TOTOP, pos=(0, 0, 0, 20))
        uicls.Line(parent=nameCont, align=uiconst.TOBOTTOM)
        levelCont = uicls.Container(name='levelCont', parent=topRightCont, align=uiconst.TOTOP, height=42, padding=(0,
         const.defaultPadding,
         0,
         0))
        ...
        label = uicls.EveLabelMedium(text=charName, parent=nameCont, left=0, align=uiconst.TOPLEFT, width=170, state=uiconst.UI_DISABLED, idx=0)
        ...
        if util.IsCharacter(self.entityID):
            ...
            bottomCont = uicls.Container(name='bottomCont', parent=self.sr.main, align=uiconst.TOALL, pos=(0, 0, 0, 0), padding=(0,
             const.defaultPadding,
             const.defaultPadding,
             const.defaultPadding))
            cbCont = uicls.Container(name='cbCont', parent=bottomCont, align=uiconst.TOTOP, pos=(0, 0, 0, 16), state=uiconst.UI_HIDDEN)
            notifyCont = uicls.Container(name='notifyCont', parent=bottomCont, align=uiconst.TOTOP, pos=(0, 0, 0, 95))
            cbCont.state = uiconst.UI_NORMAL
            self.inWatchlistCb = uicls.Checkbox(text=localization.GetByLabel('UI/PeopleAndPlaces/AddContactToWatchlist'), parent=cbCont, configName='inWatchlistCb', retval=0, checked=self.watchlist, align=uiconst.TOTOP)
            self.sendNotificationCb = uicls.Checkbox(text=localization.GetByLabel('UI/PeopleAndPlaces/SendNotificationTo', contactName=charName), parent=notifyCont, configName='sendNotificationCb', retval=0, checked=0, align=uiconst.TOTOP)
...
class ContactNotificationEntry(listentry.Generic):
    ...
    def Startup(self, *args):
        ...
        picCont = uicls.Container(name='picture', parent=self, align=uiconst.TOLEFT, width=32)
        textCont = uicls.Container(name='textCont', parent=self, align=uiconst.TOALL, padLeft=2)
        self.sr.picture = uicls.Container(name='picture', parent=picCont, align=uiconst.TOPLEFT, pos=(0, 0, 32, 32))
        self.sr.label = uicls.EveLabelMedium(text='', parent=textCont, align=uiconst.TOTOP, height=16, state=uiconst.UI_NORMAL)
        self.sr.messageLabel = uicls.EveLabelMedium(text='', parent=textCont, align=uiconst.TOTOP, height=16, state=uiconst.UI_DISABLED)
