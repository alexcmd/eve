#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/planet/resourceController.py
import uix
import uiconst
import uiutil
import planet
...
class ResourceController(uicls.ContainerAutoSize):
    ...
    def CreateLayout(self):
        legend = planet.ui.ResourceLegend(parent=self)
        planetUI = sm.GetService('planetUI')
        self.resourceList = planet.ui.ResourceList(parent=self)
...
class ResourceLegend(uicls.Container):
    ...
    def CreateLayout(self):
        ...
        self.legendContainer = uicls.Container(parent=self, name='colorFilterContainer', align=uiconst.TOTOP, statestate=uiconst.UI_PICKCHILDREN, pos=(0,
         8,
...
class ResourceList(uicls.ContainerAutoSize):
