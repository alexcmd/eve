#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/planet/planetEditModeContainer.py
import uix
import uiconst
import uicls
import planet
...
class PlanetEditModeContainer(uicls.ContainerAutoSize):
