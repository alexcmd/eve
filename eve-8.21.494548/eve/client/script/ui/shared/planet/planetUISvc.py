...
class PlanetUISvc(service.Service):
    ...
    def CreateScene(self):
        ...
        cameraParent = sm.GetService('camera').GetCameraParent('planet')
    ...
    def GetResourceAndRender(self, resourceTypeID):
        ...
        bmp = trinity.Tr2HostBitmap(PLANET_RESOURCE_TEX_WIDTH, PLANET_RESOURCE_TEX_HEIGHT, 1, trinity.PIXEL_FORMAT.B8G8R8A8_UNORM)
