#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/station/captainsquarters/mainScreen.py
import uicls
import uiconst
import util
import uiutil
    ...
    def OnClick(self, *args):
        if self.clickFunc:
            ...
            with util.ExceptionEater('eventLog'):
                sm.ProxySvc('eventLog').LogClientEvent('tutorial', 'ScreenActionClick', self.currentTemplate.__class__.__name__, self.clickFunc.__name__)
...
class ScreenNewsTicker(uicls.Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        uicls.Label(name='breakingNewsLabel', parent=self.leftCont, text='A DIVISION', fontsize=25, top=5, align=uiconst.TOPLEFT, left=85)
        uicls.Label(name='breakingNewsLabel', parent=self.leftCont, text='OF ISD', fontsize=25, top=28, align=uiconst.TOPLEFT, left=85)
