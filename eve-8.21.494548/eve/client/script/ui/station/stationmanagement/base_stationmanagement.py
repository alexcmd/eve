#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/station/stationmanagement/base_stationmanagement.py
import uix
import uiutil
import util
import form
...
class StationManagementDialog(uicls.Window):
    ...
    def LoadData(self):
        ...
        orbitName = cfg.evelocations.Get(self.station.orbitID).GetRawName(localization.LOCALE_SHORT_ENGLISH)
