#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/station/base.py
import turretSet
import sys
import service
import uix
...
class StationSvc(service.Service):
    ...
    def GetStationServices(self, service = None):
        mapping = [util.KeyVal(name='vstore', command='OpenStore', label=localization.GetByLabel('UI/Station/VirtualGoodsStore'), iconID='65_3', scope=const.neocomButtonScopeStation, serviceIDs=(-1,)),
         ...
         util.KeyVal(name='bountyoffice', command='OpenBountyOffice', label=localization.GetByLabel('UI/Station/BountyOffice/BountyOffice'), iconID='61_2', scope=const.neocomButtonScopeStationOrWorldspace, serviceIDs=(-1,)),
