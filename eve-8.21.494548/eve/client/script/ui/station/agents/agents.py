#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/station/agents/agents.py
import uix
import uthread
import blue
import util
        ...
        if isAgentInteractionMission or briefingInformation:
            ...
            if briefingInformation['Decline Time'] is not None:
                if briefingInformation['Decline Time'] == -1:
                    ...
                    timeBreakAt = 'min' if timeRemaining > MIN else 'sec'
