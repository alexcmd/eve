#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/control/eveCombo.py
import uicls
import uiconst
import uiutil
import uthread
...
class Combo(uicls.ComboCore):
    ...
    def Prepare_SelectedText_(self):
        self.sr.selected = uicls.EveLabelMedium(text='', parent=self.sr.textclipper, name='value', align=uiconst.CENTERLEFT, left=6, state=uiconst.UI_DISABLED)

    def Prepare_Underlay_(self):
        self.sr.backgroundFrame = uicls.RaisedUnderlay(parent=self)
