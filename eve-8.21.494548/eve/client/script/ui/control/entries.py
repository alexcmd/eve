#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/control/entries.py
import xtriui
import uix
import uiutil
import util
...
class Generic(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *args):
        ...
        self.sr.selection = uicls.Fill(bgParent=self, padding=(1, 1, 1, 1), color=(1.0, 1.0, 1.0, 0.25))
        self.sr.hilite = uicls.Fill(bgParent=self, padding=(1, 1, 1, 1), color=(1.0, 1.0, 1.0, 0.25))
        for eventName in events:
            setattr(self.sr, eventName, None)
    ...
    def Load(self, node):
        ...
        self.sr.label.SetTextColor(data.Get('fontColor', uicls.EveLabelMedium.default_color))
...
class StatusBar(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *args):
        ...
        self.sr.label = uicls.EveLabelSmall(text='', parent=container, idx=0, left=6, top=2, maxLines=1, state=uiconst.UI_NORMAL)
        self.sr.text = uicls.EveLabelMedium(text='', parent=container, idx=1, left=95, top=12, maxLines=1, state=uiconst.UI_NORMAL)
    ...
    def GetHeight(_self, *args):
        ...
        textheight = uix.GetTextHeight('%i/%i' % (node.status, node.total), fontsize=fontConst.EVE_MEDIUM_FONTSIZE, maxLines=1)
...
class Progress(uicls.SE_BaseClassCore):
    ...
    def Startup(self, args):
        ...
        t = uicls.EveLabelSmall(text='', parent=p, left=6, top=7, state=uiconst.UI_DISABLED, align=uiconst.CENTERLEFT)
...
class ColumnLine(uicls.SE_BaseClassCore):
    ...
    def LoadColumn(self, idx, textOrObject):
        ...
        if len(self.sr.columns) > idx:
            ...
            col.sr.textCtrl = uicls.Label(text='', parent=col, fontsize=self.sr.node.Get('fontsize', 12), letterspace=self.sr.node.Get('letterspace', 0), uppercase=self.sr.node.Get('uppercase', 0), state=uiconst.UI_DISABLED, align=uiconst.CENTERLEFT, maxLines=1)
...
class Header(uicls.SE_BaseClassCore):
    ...
    def Startup(self, args):
        self.sr.label = uicls.EveLabelMedium(text='', parent=self, left=8, top=0, state=uiconst.UI_DISABLED, maxLines=1, align=uiconst.CENTERLEFT, bold=True)
...
class Text(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *args):
        self.sr.text = self.sr.label = uicls.EveLabelMedium(text='', parent=self, left=8, top=0, state=uiconst.UI_DISABLED, color=None, maxLines=1, align=uiconst.CENTERLEFT)
        self.sr.infoicon = uicls.InfoIcon(size=16, left=2, top=2, parent=self, idx=0, align=uiconst.TOPRIGHT)
        self.sr.infoicon.OnClick = self.ShowInfo
...
class KillMail(uicls.SE_BaseClassCore):
    ...
    def GetMenu(self):
        ...
        if self.sr.node.GetMenu:
            m = self.sr.node.GetMenu()
        return m + [(uiutil.MenuLabel('UI/Commands/ShowInfo'), self.RedirectToInfo, (1,)), None, (uiutil.MenuLabel('UI/Control/Entries/CopyKillInformation'), self.GetCombatText, (1,))]
    ...
    def _OnClose(self):
        self.timer = None
        uicls.SE_BaseClassCore.Close(self)
...
class IconLabelText(uicls.SE_BaseClassCore):
    ...
    def Startup(self, args):
        self.sr.label = uicls.EveLabelSmallBold(text='', parent=self, left=8, top=4, state=uiconst.UI_DISABLED)
        self.sr.text = uicls.EveLabelSmall(text='', parent=self, left=0, top=4, align=uiconst.TOALL, state=uiconst.UI_DISABLED)
        self.sr.line = uicls.Container(name='lineparent', align=uiconst.TOBOTTOM, parent=self, state=uiconst.UI_HIDDEN, height=1)
        uicls.Fill(parent=self.sr.line)
...
class LabelMultilineTextTop(LabelTextTop):
    ...
    def Load(self, node):
        ...
        labelheight = uix.GetTextHeight(node.label, fontsize=fontConst.EVE_SMALL_FONTSIZE, maxLines=1, uppercase=1)
        textheight = uix.GetTextHeight(node.text, fontsize=fontConst.EVE_MEDIUM_FONTSIZE, maxLines=1)
        leftOffset = 2 + labelheight + textheight + 4
        self.sr.text.left = leftOffset
        self.sr.label.left = leftOffset
...
class LabelPlanetTextTop(LabelTextTop):
    ...
    def GetMenu(self):
        ...
        if locationID is not None and itemID is not None and itemID is not None:
            ...
            return [(uiutil.MenuLabel('UI/PI/Common/ViewInPlanetMode'), openPlanetFunc, (itemID,)), None] + baseMenu
        else:
            return baseMenu
...
class Button(uicls.SE_BaseClassCore):
    ...
    def Startup(self, args):
        self.sr.label = uicls.EveLabelMedium(parent=self, left=8, top=-1, state=uiconst.UI_DISABLED, maxLines=1, align=uiconst.CENTERLEFT)
        self.sr.line = uicls.Container(name='lineparent', align=uiconst.TOBOTTOM, parent=self, state=uiconst.UI_HIDDEN, height=1)
        uicls.Fill(parent=self.sr.line)
...
class ImplantEntry(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *etc):
        self.sr.label = uicls.EveLabelMedium(text='', parent=self, left=32, align=uiconst.CENTERLEFT, state=uiconst.UI_DISABLED)
        self.sr.timeLabel = uicls.EveLabelMedium(text='', parent=self, left=6, top=2, state=uiconst.UI_DISABLED, align=uiconst.BOTTOMRIGHT)
        uicls.Line(parent=self, align=uiconst.TOBOTTOM)
    ...
    def GetDynamicHeight(node, width):
        text = localization.GetByLabel('UI/Control/Entries/ImplantLabel', implantName=node.label, slotNum=0)
        textWidth, textHeight = uicls.EveLabelMedium.MeasureTextSize(text)
...
class IconEntry(uicls.SE_BaseClassCore):
    ...
    def Startup(self, *etc):
        ...
        self.sr.line = uicls.Line(parent=self, align=uiconst.TOBOTTOM)
        self.sr.icon = uicls.Icon(icon='ui_5_64_10', parent=self, pos=(0, 0, 0, 0), align=uiconst.TOPLEFT, state=uiconst.UI_DISABLED)
...
class FittingEntry(Generic):
    ...
    def Startup(self, *args):
        ...
        self.sr.label = uicls.EveLabelMedium(parent=parent, left=5, state=uiconst.UI_DISABLED, maxLines=1, align=uiconst.CENTERLEFT)
        self.sr.line = uicls.Container(name='lineparent', align=uiconst.TOBOTTOM, parent=self, height=1)
        self.sr.mainline = uicls.Fill(parent=self.sr.line)
...
exports = {'listentry.Get': Get,
 ...
 'uiutil.AllUserEntries': AllUserEntries}