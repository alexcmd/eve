...
class _GaugeBase(uicls.ContainerAutoSize):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.markers = {}
        self.gaugeCont = uicls.Container(parent=self, name='gaugeCont', height=gaugeHeight, align=uiconst.TOTOP, clipChildren=True, state=uiconst.UI_DISABLED)
        self.label = None
        if labelTxt:
...
class Gauge(_GaugeBase):
    ...
    def SetValue(self, value, frequency = 10.0, animate = True):
        ...
        if self.cyclic and self.value > value:
            ...
            uthread.new(self._SetValue, self.gauge, value, frequency, animate)
...
class GaugeMultiValue(_GaugeBase):
    ...
    def SetValue(self, gaugeNum, value, frequency = 10.0, animate = True):
        uthread.new(self._SetValue, self.gauges[gaugeNum], value, frequency, animate)
