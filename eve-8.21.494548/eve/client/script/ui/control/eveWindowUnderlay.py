#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/control/eveWindowUnderlay.py
import uicls
import uiconst
import trinity
...
class Underlay(uicls.Frame):
    __guid__ = 'uicls.Underlay'
    __notifyevents__ = ['OnUIColorsChanged']
