#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/control/eveIcon.py
import uicls
import uiconst
import uiutil
import uix
...
CORP_ICONS = {1000002: 'corps_7_128_4',
 ...
 1000261: 'res:/UI/Texture/Corps/default.png',
 1000262: 'res:/UI/Texture/Corps/default.png',
 1000263: 'res:/UI/Texture/Corps/default.png'}
    ...
    def ApplyAttributes(self, attributes):
        ...
        for each in ('iconID', 'path'):
            if each in attributes:
                print 'Someone creating icon with', each, 'as keyword', attributes.Get(each, 'None')
...
class LogoIcon(EveIcon):
    ...
    def GetFactionIconID(self, factionID, isSmall = default_isSmall):
