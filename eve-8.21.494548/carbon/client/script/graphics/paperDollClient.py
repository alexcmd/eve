#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/graphics/paperDollClient.py
import service
import paperDoll
import collections
import GameWorld
...
class PaperDollClient(service.Service):
    ...
    def paperDollManager(self):
        pdm = paperDoll.PaperDollManager(self.dollFactory, keyFunc=lambda doll: doll.GetName())
        return pdm
