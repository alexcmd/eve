...
class SliderCore(uicls.Container):
    ...
    def Prepare_Underlay_(self):
        frame = uicls.Frame(parent=self, align=uiconst.TOBOTTOM, pos=(0, 0, 0, 12), padding=(0, 0, 0, 2), frameConst=uiconst.FRAME_BORDER1_SHADOW_CORNER8, color=(1.0, 1.0, 1.0, 0.5), hint=self.hint)
