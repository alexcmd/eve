#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/control/editutils/parserbase.py
import util
import _weakref
import blue
import log
    ...
    def GetWidthInBuffer(self):
        ...
        for obj in self.textbuffer:
            if obj.type == '<overlay>':
                ...
                textWidth, textHeight = uicls.Label.MeasureTextSize(obj.letters.replace(u'\xa0', u' '), fontsize=obj.fontSize, letterspace=obj.letterSpacing, bold=bool(obj.fontFlags & fontflags.b), italic=bool(obj.fontFlags & fontflags.i))
