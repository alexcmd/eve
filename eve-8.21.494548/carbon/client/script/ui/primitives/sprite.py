        ...
        def fset(self, value):
            if self.textureSecondary:
                ...
                if value != (0, 0):
                    ...
                    if getattr(self.textureSecondary, 'atlasTexture', None) is not None:
    ...
    def rotationSecondary():
        ...
        def fset(self, value):
            if self.textureSecondary:
                ...
                if value != 0.0:
                    self.textureSecondary.useTransform = True
                    if hasattr(self.textureSecondary, 'atlasTexture'):
                        self.textureSecondary.atlasTexture.isStandAlone = True
        ...
        def fset(self, value):
            if self.texture:
                ...
                if value != 0.0:
                    ...
                    if getattr(self.texture, 'atlasTexture', None) is not None:
                        self.texture.atlasTexture.isStandAlone = True
