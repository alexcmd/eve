#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/modules/monitor.py
import blue
import uthread
import uicls
import uiutil
...
class FpsMonitor(uicls.Window):
    ...
    def StartCollectingFpsStats(self, *args):
        self.fpsStats = []
        self.startStatsBtn.Hide()
        self.stopStatsBtn.Show()
        uthread.new(self.CollectFpsThread)

    def CollectFpsThread(self):
        MAX_STATS = 36000
    ...
    def StopCollectingFpsStats(self, *args):
