#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/uitest/uitestUtils.py
...
def TextRenderTest():
    import uiconst, uicls, uiutil, trinity, blue
    ftime = blue.os.GetWallclockTimeNow()
    uicore.desktop.Flush()
    print 'flushtime', blue.os.TimeDiffInMs(ftime, blue.os.GetWallclockTime())
    uicore.ul = 0
    ...
    print 'uicore.ul', len(words)
    print 'createtime', blue.os.TimeDiffInMs(ctime, blue.os.GetWallclockTime())
...
def CreateSceneWithUI():
    ...
    tex = trinity.Tr2RenderTarget(512, 512, 1, trinity.PIXEL_FORMAT.B8G8R8A8_UNORM)
