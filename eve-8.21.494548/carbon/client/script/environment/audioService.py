#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/environment/audioService.py
import service
import blue
import audio2
import trinity
...
class AudioService(service.Service):
    ...
    def Activate(self):
        ...
        if self.jukeboxPlayer is None:
            ...
            jukeboxEventHandler = blue.classes.CreateInstance('blue.BlueEventToPython')
