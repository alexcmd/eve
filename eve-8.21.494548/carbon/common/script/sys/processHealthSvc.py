#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/common/script/sys/processHealthSvc.py
...
class ProcessHealthSvc(service.Service):
    ...
    def LogCpuMemNet(self):
        ...
        crestSvc = sm.GetServiceIfStarted('cow')
        crestRequests = crestSvc.GeTotalRequestServed() if crestSvc else 0
        callsFromClient = 0
