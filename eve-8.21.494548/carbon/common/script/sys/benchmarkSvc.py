#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/common/script/sys/benchmarkSvc.py
import blue
import blue.win32
import service
import cPickle
...
class BenchmarkService(service.Service):
    ...
    def SaveSessionFile(self, session, destination = None):
        ...
        fn = blue.paths.ResolvePathForWriting(destination)
        f = open(fn, 'wb')
        try:
