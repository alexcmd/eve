#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/common/script/net/Crypto.py
import blue
import blue.crypto
import binascii
import base64
...
if '/generatekeys' in args:
    try:
        commonFileName = blue.paths.ResolvePath('script:/../../common/script/net/public_key.py')
        serverFileName = blue.paths.ResolvePath('script:/../../server/script/net/private_key.py')
