#Embedded file name: c:\depot\games\branches\release\EVE-TRANQUILITY\carbon\common\lib\trinity\sceneRenderJobBase.py
...
class SceneRenderJobBase(object):
    ...
    def Start(self):
        if not self.scheduled:
            trinity.renderJobs.recurring.insert(0, self)
            self.scheduled = True
    ...
    def GetBackBufferRenderTarget(self):
        ...
        return trinity.renderContext.GetDefaultBackBuffer()
